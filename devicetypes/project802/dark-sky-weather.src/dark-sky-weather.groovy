...
metadata {
    ...
    preferences
    {
        input "lat", type: "text", title: "Latitude", required: true, displayDuringSetup: true, defaultValue: "38.610669"
        input "lon", type: "text", title: "Longitude", required: true, displayDuringSetup: true, defaultValue: "-94.689166"
        input "apiKey", type: "text", title: "API Key", required: true, displayDuringSetup: true, defaultValue: "7d9b1c033c5aa7f50f34efcef3a4cde0"
    }
}
